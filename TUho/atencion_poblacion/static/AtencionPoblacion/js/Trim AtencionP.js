...
var direccion = document.getElementById("inputD")
var asunto = document.getElementById("inputA");
var text = document.getElementById("inputText")
var municipality = document.getElementById("municipality-select")
var consulta = document.getElementById("consulta-select")
...
const c = (e)=>{
        ...
        if(direccion.value == ""){
          direccion.style = "border:solid 2px red;"
          mensaje += `Campo 'Dirección' en blanco <br>`
          e.preventDefault()
        }
        else{
          direccion.style = "border:solid 2px green;"
        }
        if(asunto.value == ""){
          asunto.style = "border:solid 2px red;"
          mensaje += `Campo 'Asunto' en blanco <br>`
          e.preventDefault()
        }
        else{
        ...
        if(text.value == ""){
          ...
          mensaje += `Campo 'Mensaje' en blanco <br>`
          e.preventDefault()
        }
        else{
